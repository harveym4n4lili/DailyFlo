/**
 * Sunshine (sun) fill — wake / daytime anchor rows.
 */

import React from 'react';
import Svg, { Path } from 'react-native-svg';

export type SunshineFillIconProps = {
  size?: number;
  color?: string;
};

export function SunshineFillIcon({ size = 20, color = 'currentColor' }: SunshineFillIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 20 20" accessibilityLabel="Sun">
      <Path
        fill={color}
        fillRule="evenodd"
        clipRule="evenodd"
