...
export function useThemeColors() {
  ...
  return {
    ...
    interactive: {
      ...
      quaternary: () => getThemeColor('interactive', 'quaternary'),
      quinary: () => getThemeColor('interactive', 'quinary'),
      hover: () => getThemeColor('interactive', 'hover'),
      active: () => getThemeColor('interactive', 'active'),
      disabled: () => getThemeColor('interactive', 'disabled'),
      // inverted colors - opposite theme colors for contrast sections
      ...
      invertedQuaternary: () => getThemeColor('interactive', 'invertedQuaternary'),
      invertedQuinary: () => getThemeColor('interactive', 'invertedQuinary'),
